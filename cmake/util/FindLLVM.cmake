...
macro(find_llvm use_llvm)
  ...
  elseif(NOT LLVM_CONFIG STREQUAL "OFF")
    ...
    set(__pic_llvm_libfiles "")
    foreach(__file ${__llvm_libfiles})
      string(REPLACE ".a" "_pic.a" __pic_file "${__file}")
      if (EXISTS ${__pic_file})
        list(APPEND __pic_llvm_libfiles "${__pic_file}")
      else()
        list(APPEND __pic_llvm_libfiles "${__file}")
      endif()
    endforeach()
    set(LLVM_LIBS "${__pic_llvm_libfiles} ${__llvm_system_libs}")
